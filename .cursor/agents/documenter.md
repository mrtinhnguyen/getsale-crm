...
**IMPORTANT:** All paths are configurable per project via `.cursor/config.json`. The example above matches the current project defaults. Users can customize to `docs/`, `documentation/`, or any other structure.
